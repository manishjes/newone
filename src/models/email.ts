...
const templates = [
  {
    ...
    subject: "One Time Password | sankalp",
    body: `<table
    cellpadding="0"
    cellspacing="0"
    class="es-content"
  ...
  },
  {
    ...
    subject: "Reset Password | sankalp",
    body: ` <table
    cellpadding="0"
    cellspacing="0"
    class="es-content"
  ...
  },
  {
    ...
    subject: "Your Credentials | sankalp",
    body: `
    <table
    cellpadding="0"
    cellspacing="0"
  ...
  },
  {
    ...
    subject: "Request Accepted | sankalp",
    body: `
    <table
    cellpadding="0"
    cellspacing="0"
                      ...
                      <tr>
                        ...
                        >
                          ...
                          <p
                            ...
                            "
                          >
                          Your request at {{payload.outletName}} for table booking at {{payload.date}} has been confirmed
                          <table style="margin-top: 10px; font-family: Poppins, sans-serif;color: #5d541d; ">
                          </table>
                          </p>
                        </td>
  ...
  },
  {
    ...
    subject: "Request Rejected | sankalp",
    body: `
    <table
    cellpadding="0"
    cellspacing="0"
                      ...
                      <tr>
                        ...
                        <h3
                          ...
                          <p
                            ...
                            "
                          >
                           Your request at {{payload.outletName}} for table booking at {{payload.date}} has been rejected
                          <table style="margin-top: 10px; font-family: Poppins, sans-serif;color: #5d541d; ">
